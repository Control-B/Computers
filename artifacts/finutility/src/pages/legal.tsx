      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 md:px-8 py-16 max-w-3xl">
          ...
          <div className="prose prose-blue max-w-none text-muted-foreground">
            ...
            <p>
              The information and calculators provided on freetawn are for educational and informational purposes only. They do not constitute financial, legal, tax, or investment advice. 
            </p>
            <p>
              While we strive to ensure the accuracy of our mathematical models, freetawn makes no guarantees regarding the accuracy, completeness, or applicability of any calculations to your specific situation. The financial insights provided are generated based on your calculator inputs and publicly available market data, and should not be interpreted as personalized financial advice.
            </p>
            <p>
            ...
            <p>
              freetawn is designed to be privacy-first. <strong>All calculations are performed locally in your web browser.</strong> We do not collect, store, transmit, or share the financial data you enter into our calculators.
            </p>
            <p>
            ...
            <p>
              By using freetawn, you agree to use the site for personal, non-commercial purposes. You may not scrape, copy, or reverse-engineer our proprietary calculators or insight logic without explicit permission.
            </p>
            <p>
